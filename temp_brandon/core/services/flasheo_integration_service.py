...
FLASHEO_API_URL = "http://localhost:8080/api/v1/onus/{query}/credentials"
FLASHEO_ROOT = r"C:\Users\bcarrero\Documents\Estacion de flasheo"
FLASHEO_DB_PATH = os.path.join(FLASHEO_ROOT, "config", "estacion_flasheo.db")
